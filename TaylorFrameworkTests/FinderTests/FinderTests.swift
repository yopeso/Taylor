        ...
        describe("Finder") {
            context("when init with excluded directories and files") {
                it("should return list without excluded paths") {
                    input = ["path": ["/Home/Finder"],
                        ...
                        "type": ["swift"]]
                    expect {
                        finder.findFilePaths(parameters: input).count
                        }.to(equal(2))
                    expect {
                        finder.findFilePaths(parameters: input)
                        }.to(contain("/Home/Finder/Finder/main.swift", "/Home/Finder/Finder/Controllers/MainViewController.swift"))
                }
                it("should return list without files from all directory with name Controllers") {
                    ...
                    expect {
                        finder.findFilePaths(parameters: input)
                        }.to(contain("/Home/Finder/FinderTests/FinderTests.swift", "/Home/Finder/Finder/main.swift"))
                }
                it("should return list without files from all directory with name contains Tests") {
                    ...
                    expect {
                        finder.findFilePaths(parameters: input)
                        }.to(contain("/Home/Finder/Finder/main.swift", "/Home/Finder/Finder/Controllers/AccountViewController.swift", "/Home/Finder/Finder/Controllers/MainViewController.swift"))
                }
            }
            ...
            context("when init with file paths for include") {
                ...
                it("should return explicitly included files no matter what") {
                    ...
                    expect {
                        finder.findFilePaths(parameters: input)
                        }.to(contain("/Home/Finder/FinderTests/FinderTests.swift"))
                }
            }
